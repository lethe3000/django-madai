(function( $ ) {
    $.widget("metro.scrollbar", {
        ...
        _create: function() {
            ...
            if(elem.data('scrollbardisplay') != undefined) {
              this.options.scrollbarDisplay = elem.data('scrollbardisplay');
            }
            if(elem.data('enablemousewheel') != undefined) {
              this.options.enableMousewheel = elem.data('enablemousewheel');
            }
            elem.css({
                position: 'relative'
            });
        ...
        _verticalScrollbar: function () {
            ...
            if (this.options.scrollbarDisplay) {
